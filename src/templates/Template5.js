...
const Template5 = forwardRef(({ data, isGenerating = false }, ref) => {
          ...
          >
            ...
            >
              ...
              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2 }}>
                ...
                <Typography>
                  <strong>Telefone:</strong> {data.personalInfo.phone}
                </Typography>
                <Typography>
                  <strong>Endereço:</strong> {data.personalInfo.address}
                </Typography>
            ...
            <Typography variant="h5" sx={{ color: '#1976d2', mt: 3, mb: 1 }}>
              Objetivo
            </Typography>
...
export default function Template5Wrapper(props) {
  ...
  return <Template5 {...props} onBack={props.onBack || handleBack} />;
}
