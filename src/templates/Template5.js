...
const Template5 = forwardRef(({ data, onBack, onPrint, isGenerating }, ref) => {
...
const Template5Wrapper = (props) => {
  ...
  return <Template5 ref={null} {...props} onBack={handleBack} onPrint={handlePrint} isGenerating={false} />;
};
