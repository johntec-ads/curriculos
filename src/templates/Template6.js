        ...
        >
          ...
          <Box
            sx={{
              ...
              '@media print': {
                background:
                  'linear-gradient(90deg, #1976d2 0%, #5e9ce9 100%) !important',
                color: '#fff !important',
                display: 'flex !important',
                gap: '32px !important',
          ...
          >
            ...
            >
              {!data.personalInfo.photoUrl && data.personalInfo.name
            ...
            >
              ...
              {data.personalInfo.objective && (
                <Typography
                  variant="body1"
                  sx={{ mb: 2, fontStyle: 'italic', maxWidth: '80%' }}
                >
                  {data.personalInfo.objective}
                </Typography>
              )}
...
export default function Template6Wrapper(props) {
  ...
  return <Template6 {...props} onBack={props.onBack || handleBack} />;
}
