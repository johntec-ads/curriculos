...
import { pdfTemplates, hasPDFTemplate as checkHasPDFTemplate, availablePDFTemplates } from '../templates/pdf';
 ...
 */
export const generatePDFWithReactPDF = async (data, templateId = 1, filename = 'curriculo.pdf', options = {}) => {
  const {
    onProgress = null,
    returnBlob = false,
  } = options;
  ...
  try {
    ...
    const numericId = typeof templateId === 'string' 
